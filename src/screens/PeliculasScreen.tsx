...
import { theme } from '../components/theme'; // Asegúrate de que esta ruta relativa sea correcta en tu proyecto
import { Ionicons } from '@expo/vector-icons';
import { useNavigation } from '@react-navigation/native';

export default function PeliculasScreen() {
  const navigation = useNavigation<any>(); // Instanciamos el hook de React Navigation
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          // Usamos navigation.navigate con el nombre exacto de la pantalla definida en AppNavigator.tsx
          onPress={() => navigation.navigate('MapaAsientosScreen')}
        >
          <Image
